...
namespace sge {
	...
	public:
		...
		inline static bool Slider(const char* label, Vec2i&	value, f32 min, f32 max) { return ImGui::SliderInt2  (label, value.data, (int)min, (int)max); }
		inline static bool Slider(const char* label, Vec3i&	value, f32 min, f32 max) { return ImGui::SliderInt3  (label, value.data, (int)min, (int)max); }
