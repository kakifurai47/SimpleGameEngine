...
namespace sge {
	...
	template<> SGE_INLINE Vec3f_SSE Vec3f_SSE::operator+ (const float& s) const { return Vec3_SSE_make(_mm_add_ps(_m, _mm_set1_ps(s))); }
	template<> SGE_INLINE Vec3f_SSE Vec3f_SSE::operator- (const float& s) const { return Vec3_SSE_make(_mm_sub_ps(_m, _mm_set1_ps(s))); }
	template<> SGE_INLINE Vec3f_SSE Vec3f_SSE::operator* (const float& s) const { return Vec3_SSE_make(_mm_mul_ps(_m, _mm_set1_ps(s))); }
	template<> SGE_INLINE Vec3f_SSE Vec3f_SSE::operator/ (const float& s) const { return Vec3_SSE_make(_mm_div_ps(_m, _mm_set1_ps(s))); }

	template<> SGE_INLINE Vec3d_SSE Vec3d_SSE::operator+ (const double& s) const { return Vec3_SSE_make(_mm256_add_pd(_m, _mm256_set1_pd(s))); }
	template<> SGE_INLINE Vec3d_SSE Vec3d_SSE::operator- (const double& s) const { return Vec3_SSE_make(_mm256_sub_pd(_m, _mm256_set1_pd(s))); }
	template<> SGE_INLINE Vec3d_SSE Vec3d_SSE::operator* (const double& s) const { return Vec3_SSE_make(_mm256_mul_pd(_m, _mm256_set1_pd(s))); }
	template<> SGE_INLINE Vec3d_SSE Vec3d_SSE::operator/ (const double& s) const { return Vec3_SSE_make(_mm256_div_pd(_m, _mm256_set1_pd(s))); }
